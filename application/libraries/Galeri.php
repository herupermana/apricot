...
class Galeri
{
    ...
    public function semua_galeri($limit, $offset)
    {
        $limit = intval($limit);
    ...
    public function hitung_semua_galeri()
    {
        $data = $this->CI->db->query("SELECT galeri.galeri_id AS id,
			galeri.galeri_nama AS nama,
			galeri.galeri_deskripsi AS deskripsi,			
    ...
    public function galeri_per_kategori($id_kategori, $limit, $offset)
    {
    ...
    public function hitung_galeri_per_kategori($id_kategori)
    {
        $id_kategori = intval($id_kategori);
    ...
    public function detail_galeri($id)
    {
        ...
        if ($cache_galeri === false) {
			...
			");
            $data = ['jumlah'=>$data->num_rows(), 'data'=>$data->row_array()];
