...
class Artikel
{
    ...
    public function related_artikel_per_kategori($artikel_aktif, $id_kategori, $limit = 5)
    {
    ...
    public function artikel_per_kategori($id_kategori, $limit, $offset)
    {
        $id_kategori = intval($id_kategori);
        $limit = intval($limit);
    ...
    public function hitung_semua_artikel_per_kategori($id_kategori)
    {
        $id_kategori = intval($id_kategori);
    ...
    public function artikel_per_tag($id_slug, $limit, $offset)
    {
    ...
    public function hitung_semua_artikel_per_tag($id_slug)
    {
        $id_slug = intval($id_slug);
    ...
    public function search_article($keyword, $limit, $offset)
    {
        $limit = intval($limit);
        $offset = intval($offset);
    ...
    public function hitung_search_article($keyword)
    {
        $data = $this->CI->db->query("SELECT artikel.artikel_id AS id,
		 artikel.artikel_judul AS judul, 
		 artikel.artikel_isi AS isi,
    ...
    public function artikel_semua($limit, $offset)
    {
        $limit = intval($limit);
        $offset = intval($offset);
    ...
    public function hitung_semua_artikel()
    {
        $data = $this->CI->db->query("SELECT artikel.artikel_id AS id,
		 artikel.artikel_judul AS judul, 
		 artikel.artikel_isi AS isi,
