...
if (file_exists('../starting') and isset($_POST['nama_database'])) {
    ...
    $listString = ['http://localhost/apricot', 'http://localhost/cms'];
    ...
    $db->prepare('UPDATE informasi SET nama=:nama WHERE id=:id')->execute(['nama'=>$nama_website, 'id'=>1]);
 ...
 ->execute(['name_user'=> $nama_user_login,
