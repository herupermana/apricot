...
$config = [
    ...
    */
    ...
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']), ['off', 'no'])) ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'], //edited
    ...
    */
    ...
    'access_keys' => [isset($_SESSION['random_filemanager_key']) ? $_SESSION['random_filemanager_key'] : md5(uniqid(rand(), true))], //edited
    ...
    */
    ...
    //**********************
    'ext_img'                                 => ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg', 'ico'], //Images
    'ext_file'                                => [], //Files 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai' (edited)
    'ext_video'                               => [], //Video 'mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', "flv", "webm" edited
    'ext_music'                               => [], //Audio 'mp3', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav'  edited
    'ext_misc'                                => [], //Archives   'zip', 'rar', 'gz', 'tar', 'iso', 'dmg'   edited
    ...
    'fixed_path_from_filemanager'             => ['', ''], //fixed path of the image folder from the current position on upload folder
    ...
    'relative_path_from_current_pos'          => ['', ''], //relative path of the image folder from the current position on upload folder (edited)
    'relative_image_creation_name_to_prepend' => ['', ''], //name to prepend on filename
    'relative_image_creation_name_to_append'  => ['', ''], //name to append on filename
    'relative_image_creation_width'           => [300, ''], //width of image (you can leave empty if you set height)
    'relative_image_creation_height'          => [300, ''], //height of image (you can leave empty if you set width) //FUCK THIS PART!!!!!!!!!!!! edited
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    #                          4 / crop= resize and crop;
     */
    'relative_image_creation_option'          => ['auto', 'auto'], //set the type of the crop
